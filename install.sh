...
install -m 0755 "$ROOT_DIR/usr/local/bin/qBitPuller-lidarr-cleanup.py" /usr/local/bin/qBitPuller-lidarr-cleanup.py
...
install -m 0644 "$ROOT_DIR/etc/systemd/system/qBitPuller-lidarr-cleanup.service" /etc/systemd/system/qBitPuller-lidarr-cleanup.service
